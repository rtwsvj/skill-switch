...
|---|---|---|---|
| [vercel-labs/skills](https://github.com/vercel-labs/skills) | MIT(声明于上游 package.json,上游无独立 LICENSE 文件) | `be0dd25b` | agent 映射表与类型 + git/source-parser/local-lock(`src/vendor/vercel-skills/`;本地适配改动见 UPSTREAM.md) |
| [Karanjot786/agent-skills-cli](https://github.com/Karanjot786/agent-skills-cli) | MIT | `956140bf` | 冲突检测、上下文预算(`src/vendor/agent-skills-cli/`) |
